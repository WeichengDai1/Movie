...
public class ClientRequest
{
    ...
    public ClientRequest(String email, String session_id, String transaction_id, String URI, String endpoint, HTTPMethod method, byte[] requestBytes, HashMap<String, String> query)
    {
        this.email = email;
