package edu.uci.ics.weiched.service.gateway.connectionpool;
...
public class ConnectionPoolManager
{
    ...
    public Connection requestCon()
    {
        ...
        try {
            ...
            e.printStackTrace();
            ServiceLogger.LOGGER.warning("cannot request connections from hikariConPool.");
        }
        return null;
    }
    ...
    public void releaseCon(Connection con)
    {
        ...
        try {
            ...
            e.printStackTrace();
            ServiceLogger.LOGGER.warning("cannot release connection back to hikariConPool.");
        }
    }
}
